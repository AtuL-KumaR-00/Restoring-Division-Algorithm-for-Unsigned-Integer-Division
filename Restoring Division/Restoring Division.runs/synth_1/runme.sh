...
HD_PWD='C:/Users/acer/Restoring Division/Restoring Division.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_4x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divider_4x4.tcl
